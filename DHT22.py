...
class sensor:
   ...
   def _cb(self, gpio, level, tick):
      ...
      if level == 0:
         ...
         if self.bit == -2 or self.bit == -1 and  val == 1:
            if val == 1:
              self.valBits = "1"
            else:
              self.valBits = "0"
            ...
            if val == 1:
              self.valBits = str(self.valBits) + "1"
            else:
              self.valBits = str(self.valBits) + "0"
